**Send code**
----
  Sends sms with secure code and checks whether the limit has been exceeded. Returns whether the user with this phone number is registered. This method does not create a user.
